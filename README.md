...
제출용 문구와 데모 시나리오는 [docs/PLAYMCP_SUBMISSION.md](docs/PLAYMCP_SUBMISSION.md)에, 실제 입력 필드는 [docs/PLAYMCP_FORM_VALUES.md](docs/PLAYMCP_FORM_VALUES.md)에 정리되어 있습니다.
