...
제출 화면에 넣을 값은 [KAKAO_FORM_VALUES.md](./KAKAO_FORM_VALUES.md)에 정리되어 있습니다.
...
[
  {"id":"kakao_001","text":"나에게 보내기로 옮긴 에어컨 사진","hint":"전자제품"},
...
- [ ] `git ls-remote --heads https://github.com/studyreadbook4ever/labelbridge-mcp.git main`으로 PlayMCP가 clone할 수 있는지 확인
- [ ] Kakao Cloud 또는 접근 가능한 HTTPS 환경에 서버 배포
- [ ] `PUBLIC_BASE_URL`을 실제 공개 URL로 설정
