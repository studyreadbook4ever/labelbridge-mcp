...
- Transport: Streamable HTTP (`/mcp` supports POST JSON-RPC, GET SSE probe, DELETE, and OPTIONS preflight)
- Runtime: Node.js 24+
...
- [x] `npm run check:submission`으로 제출값 길이, 식별자, 대표 이미지, Git ref 확인
